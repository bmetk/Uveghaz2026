...
* 🖥️ **Raspberry Pi 4:** `192.168.10.193`
* 🖥️ **Raspberry Pi 3:** `192.168.10.177`
...
### 🔐 Rendszer hitelesítési adatok (SSH / OS)
Mindkét Raspberry Pi az alábbi alapértelmezett adatokkal érhető el távolról:
* **Felhasználónév:** `pi`
* **Jelszó:** `raspberry`
...
3. **Képernyő felosztása:** 
    * Miután megnyílt a két böngészőlap (vezérlés és monitorozás), nyomd meg és tartsd lenyomva az <kbd>Alt</kbd> billentyűt.
...
* **Közvetlen elérés (Saját router):** [http://192.168.10.193:1880/dashboard/control]
* **Közvetlen elérés (Office Wi-Fi):** [http://172.22.0.136:1880/dashboard/control]
...
* 🔄 **Alaphelyzet gomb**
    * A <kbd>Reset</kbd> gomb megnyomásával minden beavatkozót azonnal alaphelyzetbe tudsz állítani.
* 🎛️ **Egyéb blokkok**
...
* **Közvetlen elérés (Saját router):** [http://192.168.10.193:1880/dashboard/automation]
* **Közvetlen elérés (Office Wi-Fi):** [http://172.22.0.136:1880/dashboard/automation]
